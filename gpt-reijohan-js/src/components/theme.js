class ChatTheme extends HTMLElement {
  ...
  constructor() {
    ...
    this.shadow.innerHTML = /* html */ `
      ...
      <style>
        ...
        .theme-switch-container {
          ...
          box-sizing: border-box;
          border-top: 0.0625rem solid hsl(0, 0%, 15%);
        ...
        .theme-switch {
          ...
          padding: 0 0.4375rem;
          box-sizing: border-box;
          border: 0.0625rem solid hsl(0, 0%, 27%);
        ...
        .theme-switch-slider {
          ...
          box-shadow: 0 0.125rem 0.375rem hsla(0, 0%, 0%, 0.35);
    ...
    this.themeSwitch = this.shadowRoot.querySelector(".theme-switch");
  ...
  connectedCallback() {
    this.themeSwitch.addEventListener("click", this.handleClick);
    this.themeSwitch.addEventListener("keydown", this.handleKeyDown);
  ...
  disconnectedCallback() {
    ...
    this.themeSwitch.removeEventListener("click", this.handleClick);
    this.themeSwitch.removeEventListener("keydown", this.handleKeyDown);
  ...
  toggleTheme() {
    ...
    if (typeof sidebar.setTheme === "function") {
